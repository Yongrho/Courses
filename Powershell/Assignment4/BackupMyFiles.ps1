...
$Versions = $NumberOfBackups.ToString() #How many of the last Backups you want to keep
$Backupdirs = $Sources #What Folders you want to backup
$ExcludeDirs = $Backupdirs + "\Temp" #This list of Directories will not be copied
        ...
        try {
            ...
            foreach ($Backup in $FinalBackupdirs) {
                ...
                foreach ($File in $Files) {
                    ...
                    try {
                        if($File.DirectoryName -notmatch $exclude ) {   
